...
Note that the CharClient provides a virtual function for stub creation. This
allows us to choose the implementation to be used on the test. We can achieve
this by extending CharClient to implement this function and define the behaviour
of the Mock object. The rest of the code being tested is from the base class.
